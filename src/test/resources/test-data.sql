...
VALUES (1000, TRUE, 'Admin', 'Istrator', 'passwd', 'admin', 1000, '2024-01-01 00:00:00', 'ADMIN');

INSERT INTO USERX (ID, ENABLED, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, CREATE_USER_ID, CREATED_DATE, ROLE)
VALUES (2000, TRUE, 'Susi', 'Kaufgern', 'passwd', 'user1', 1000, '2024-01-01 00:00:00', 'MANAGER');

INSERT INTO USERX (ID, ENABLED, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, CREATE_USER_ID, CREATED_DATE, ROLE)
VALUES (3000, TRUE, 'Max', 'Mustermann', 'passwd', 'user2', 1000, '2024-01-01 00:00:00', 'CUSTOMER');

INSERT INTO USERX (ID, ENABLED, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, CREATE_USER_ID, CREATED_DATE, ROLE)
VALUES (4000, TRUE, 'Elvis', 'The King', 'passwd', 'elvis', 1000, '2024-01-01 00:00:00', 'ADMIN');

INSERT INTO USERX (ID, ENABLED, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, CREATE_USER_ID, CREATED_DATE, ROLE)
VALUES (5000, TRUE, 'Man', 'Ager', 'passwd', 'manager', 1000, '2024-01-01 00:00:00', 'MANAGER');

INSERT INTO USERX (ID, ENABLED, FIRST_NAME, LAST_NAME, USERNAME, PASSWORD, CREATE_USER_ID, CREATED_DATE, ROLE)
VALUES (6000, TRUE, 'Jonny', 'Denber', 'jonny', 'passwd', 1000, '2024-01-01 00:00:00', 'CUSTOMER');

INSERT INTO USERX (ID, ENABLED, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, CREATE_USER_ID, CREATED_DATE, ROLE)
VALUES (7000, TRUE, 'Admin2', 'Istrator', 'passwd', 'admin2', 1000, '2024-01-01 00:00:00', 'ADMIN');

INSERT INTO USERX (ID, ENABLED, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, CREATE_USER_ID, CREATED_DATE, ROLE)
VALUES (8000, TRUE, 'Custo', 'Mer', 'passwd', 'customer', 1000, '2024-01-01 00:00:00', 'CUSTOMER');
...
VALUES (9000, 6000, 'PENDING', 100.00, CURRENT_TIMESTAMP);

INSERT INTO ORDERS (ID, USER_ID, STATUS, SUM, CREATED_DATE)
VALUES (8000, 6000, 'PENDING_PAYMENT', 100.00, CURRENT_TIMESTAMP);
