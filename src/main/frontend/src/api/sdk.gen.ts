...
export const createUser1 = <ThrowOnError extends boolean = false>(options: Options<CreateUser1Data, ThrowOnError>) => (options.client ?? client).post<CreateUser1Responses, unknown, ThrowOnError>({
