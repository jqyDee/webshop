...
export const unsubscribe = <ThrowOnError extends boolean = false>(options: Options<UnsubscribeData, ThrowOnError>) => (options.client ?? client).delete<UnsubscribeResponses, unknown, ThrowOnError>({ url: '/api/product/{id}/unsubscribe', ...options });

export const deleteUserProductSubscription = <ThrowOnError extends boolean = false>(options: Options<DeleteUserProductSubscriptionData, ThrowOnError>) => (options.client ?? client).delete<DeleteUserProductSubscriptionResponses, unknown, ThrowOnError>({ url: '/api/admin/user/{id}/unsubscribe/{productId}', ...options });
