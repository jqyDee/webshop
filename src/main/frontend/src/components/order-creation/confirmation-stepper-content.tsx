...
export const ConfirmationStepperContent: React.FC<ConfirmationStepperContentProps> = (props) => {
    ...
    return (<>
        ...
        <DataTable title={"Products"} value={props.order.products}>
            <Column body={(item: OrderItemDto) => <img className="w-9 sm:w-8rem xl:w-5rem shadow-2 block xl:block mx-auto border-round"
        ...
        <Button label={"Continue Shopping"} onClick={() => navigate(ROUTES.HOME)}/>
    </>);
}