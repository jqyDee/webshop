...
const AddressStepperContent: React.FC<AddressStepperPanelProps> = (props) => {
...
export type ValidationResult<D extends Object> = { valid: boolean; message?: string; } & Partial<Record<keyof D, string>>;
...
export default AddressStepperContent;