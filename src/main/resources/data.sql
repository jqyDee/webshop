...
VALUES (1000, (SELECT ID FROM USERX WHERE USERNAME = 'user1'),'COMPLETED',917.68,'2024-02-15 14:30:00');
...
INSERT INTO ORDERS (ID, USER_ID, STATUS, SUM, CREATED_DATE)
VALUES (2000, (SELECT ID FROM USERX WHERE USERNAME = 'user1'),'PENDING',380.99,'2024-03-01 10:15:00');

INSERT INTO ORDER_ITEM (ID, ORDER_ID, PRODUCT_ID, QUANTITY, NAME, TOTAL)
VALUES(2000, 2000, 5000, 1, 'Item3', 380.99);

INSERT INTO ORDERS (ID, USER_ID, STATUS, SUM, CREATED_DATE)
VALUES (3000, (SELECT ID FROM USERX WHERE USERNAME = 'user1'),'COMPLETED',280.99,'2024-03-02 11:00:00');

INSERT INTO ORDER_ITEM (ID, ORDER_ID, PRODUCT_ID, QUANTITY, NAME, TOTAL)
VALUES(3000, 3000, 2000, 1, 'Item4');