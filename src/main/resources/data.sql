...
INSERT INTO USERX (ENABLED, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, CREATE_USER_ID, CREATED_DATE, ROLE)
VALUES (TRUE, 'Kate', 'Mustermann', '{bcrypt}$2b$12$gimw81jnsxtcHMBRe6LVe.NZCPf3G2ugUyKqcYwJRlJuN6ubTXkNS', 'user3', NULL, '2024-01-01 00:00:00', 'CUSTOMER');
...
VALUES(1000, 1000, 1000, 1, (SELECT NAME FROM PRODUCT WHERE ID = 1000), 580.99),
    (1100, 1000, 3000, 1, (SELECT NAME FROM PRODUCT WHERE ID = 3000), 336.69);
