...
INSERT INTO ORDERX (USER_ID, STATUS, SUM, CREATED_DATE)
VALUES ((SELECT ID FROM USERX WHERE USERNAME = 'user1'),'COMPLETED',917.68,'2024-02-15 14:30:00');

INSERT INTO ORDER_ITEM (ORDER_ID, PRODUCT_ID, QUANTITY, PRICE)
VALUES((SELECT MAX(ID) FROM ORDERX), 1000, 1, 580.99),
    ((SELECT MAX(ID) FROM ORDERX), 3000, 1, 336.69);

INSERT INTO ORDERX (USER_ID, STATUS, SUM, CREATED_DATE)
VALUES ((SELECT ID FROM USERX WHERE USERNAME = 'user1'),'PENDING',380.99,'2024-03-01 10:15:00');

INSERT INTO ORDER_ITEM (ORDER_ID, PRODUCT_ID, QUANTITY, PRICE)
VALUES((SELECT MAX(ID) FROM ORDERX), 5000, 1, 380.99);

INSERT INTO ORDERX (USER_ID, STATUS, SUM, CREATED_DATE)
VALUES ((SELECT ID FROM USERX WHERE USERNAME = 'user2'),'COMPLETED',280.99,'2024-03-02 11:00:00');

INSERT INTO ORDER_ITEM (ORDER_ID, PRODUCT_ID, QUANTITY, PRICE)
VALUES((SELECT MAX(ID) FROM ORDERX), 2000, 1, 280.99);